...
****** variables
       #+begin_src emacs-lisp
         (custom-set-variables 'evil-embrace-show-help-p nil)
       #+end_src
****** hooks
       #+begin_src emacs-lisp
...
***** config
      ...
      #+end_src
      In fact, just enable it globally, then add to =aggressive-indent-exclude-modes= if there's a mode to be excluded.
      #+begin_src emacs-lisp
